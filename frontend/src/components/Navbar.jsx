...
const Navbar = () => {
  ...
  <div className="flex flex-row gap-2">
    ...
    <h1 className={`font-bold text-3xl max-md:text-2xl ${currentTheme === "dark" ? "text-sky-300" : "text-blue-400"}`}>
  ...
  <ul className={`flex flex-row justify-evenly items-center gap-5 max-sm:hidden max-xl:gap-3 max-md:gap-2 ${currentTheme === "dark" ? "text-white" : ""}`}>
    <li><a href="/">Home</a></li>
