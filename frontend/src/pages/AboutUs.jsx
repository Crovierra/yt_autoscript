...
const AboutUs = () => {
  ...
  return (
    ...
    <div className={`p-[5%] flex flex-col gap-2 max-lg:w-[80%] w-[60%] h-auto rounded-xl justify-center shadow-md outline-gray-200 outline-[1px] ${currentTheme === "dark" ? "bg-neutral-900 text-white" : ""} duration-300`}>
