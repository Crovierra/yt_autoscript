...
const Home = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="flex flex-row items-center gap-3 ml-[-10px]">
      <FaPencilAlt className="text-2xl text-blue-400"/>
      <h2 className="text-4xl text-blue-400 font-bold">YouTube Video to Text Converter</h2>   
      </div>
      <p className="w-[800px] h-[40px] text-center my-[1%]">Transform your YouTube videos into text transcripts instantly. Professional-grade conversion that's free, lightning-fast, and incredibly simple to use.</p>
      <div className="flex flex-row justify-center items-center gap-6 my-[2%] text-gray-600">
        ...
        <div className="flex flex-row rounded-2xl w-[800px] h-[100px] justify-center items-center shadow-md gap-4">
            <input placeholder="Paste Youtube Video URL here" className="bg-gray-100 w-[400px] outline px-[10px] h-[40px] rounded-md outline-gray-300 active:outline-blue-400"></input>
