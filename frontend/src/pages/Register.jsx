...
const Register = () => {
  ...
  return (
    <div className={`flex flex-col justify-center items-center w-screen h-screen max-md:pt-[12%] ${currentTheme === "dark" ? "bg-neutral-700 text-white" : ""} duration-300`}>
    <form action="POST" className="flex flex-col gap-2 items-center" onSubmit={newRegister}>
      ...
      <p>Have an account ? <a className={`${currentTheme === "dark" ? "text-sky-300" : "text-blue-400"} font-semibold`}  href="/login">Login</a> now</p>
